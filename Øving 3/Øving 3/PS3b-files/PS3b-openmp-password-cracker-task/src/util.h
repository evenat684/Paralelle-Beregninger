...
#define MAX_SEPARATOR_LENGTH 7
#define MAX_SHADOW_USER_LENGTH 63
#define MAX_SHADOW_PASSFIELD_LENGTH 255
#define MAX_PASSWORD_LENGTH 127
#define MAX_DICT_ELEMENT_LENGTH 127
...
typedef struct {
    // User field
    char user[MAX_SHADOW_USER_LENGTH + 1];
    // "Encrypted password" field, including salt, parameters and password hash
    char passfield[MAX_SHADOW_PASSFIELD_LENGTH + 1];
    // Hash algorithm
    CryptAlg alg;
